...
Denne rapport udsprigner af en diskussion med Lars Juel Hansen (sommeren 2019) om en forslået tommelfingerregel for netop vurderingen kollisionskurs. Formuleringen for det vi fremadrettet skal kalde for \text{baggrundsmetoden} lyder som følger:
\begin{quote}
